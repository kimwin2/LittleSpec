...
# DRAFT_MODEL_PATH="outputs/step1_draft_0.1bit_200k/<timestamp>"
DRAFT_MODEL_PATH=""
...
echo "============================================================"
echo "Full Pipeline: Matryoshka Speculative Decoding Training (200K)"
echo "  Model:    ${MODEL_ID}"
...
echo "============================================================"
echo "Full Pipeline Complete! (200K samples)"
